...
// modeling6.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(Cmodeling6App, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание Cmodeling6App

Cmodeling6App::Cmodeling6App()
{
...
// Единственный объект Cmodeling6App

Cmodeling6App theApp;


// Инициализация Cmodeling6App

BOOL Cmodeling6App::InitInstance()
{
